...
urlpatterns = [
    ...
    path('hen-nhan-quyen/', views.folder_appointment_report_view, name='folder_appointment_report_v2'),
    path('hen-nhan-quyen/export/', views.folder_appointment_export_view, name='folder_appointment_export'),
    ...
    path('api/folder/<int:folder_id>/appointment-v2/', views.api_folder_appointment_v2, name='api_folder_appointment_v2'),
    ...
    path('api/gddb/claims/bulk/', views.api_gddb_bulk_claim, name='api_gddb_bulk_claim'),
    path('api/gddb/<int:registration_id>/claim/', views.api_gddb_case_claim, name='api_gddb_case_claim'),
